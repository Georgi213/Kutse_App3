    ...
    public class HomeController : Controller
    {
        ...
        private void E_mail(Guest guest)
        {
            try
            {
                ...
                WebMail.UserName = "georgiblinov096@gmail.com";
                WebMail.Password = "47304290263Geo";
                WebMail.From = "georgiblinov096@gmail.com";
                WebMail.Send("georgiblinov096@gmail.com", "Vastus kutsele", guest.Name + " vastas " + ((guest.WillAttend ?? false) ? "tuleb peole " : "ei tule peole"));
